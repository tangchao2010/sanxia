	...
	<body style="background:#f5f5f5" >
            ...
            <div class="zccg_container">
                ...
                <div style=" text-align:center; padding-top:15%; padding-bottom:20%" >
                    <a href="<%=request.getContextPath()%>/Manage/machManage?openid=${openid}&oemid=${oemid}" >
                    	<input id="businestj_suc" type="button" value="返回管理首页" style=" text-shadow:none; background:#073348; border:none;  width:90%;text-decoration:none; color:#fff; font-family:'微软雅黑';" class=" btn  btn-default btn-lg">
                	</a>
                </div>
           </div>  
        </div>
