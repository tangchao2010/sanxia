...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<style>
			...
			*{color:;}
			...
			.zccg_img p{ margin-left:15px; margin-right:15px; color:#000; padding-top:2%; font-size:20px; padding-bottom:10%; line-height:20px; font-family:'微软雅黑'; text-align:center; border-bottom:dotted 1px #e3e3e3;}
        ...
        <script>
			onclickhide = function(obj){
				...
				window.location.href="<%=request.getContextPath()%>/Manage/sq?orgCode="+orgCode+"&oemid="+oemid+"&openid="+openid;
			}
		</script>	
	</head>
	...
	<body style="background:#f5f5f5" >
            ...
            <div class="zccg_container">
                <div class="zccg_img">
                    <img class="img-responsive" width="120"  src="<%=request.getContextPath()%>/img/imgs/zjzf_logo.png">
                     <p></p>
                </div>
                ...
                <input type="hidden"  id="openid" value="${openid }"/>
                    <a >
                    	<input  id="subhold" type="button" value="升迁" onclick="onclickhide(this)"  style=" text-shadow:none; background:#073348; border:none;  width:90%;text-decoration:none; color:#fff; font-family:'微软雅黑';" class=" btn  btn-default btn-lg"><!--onClick="this.style.visibility='hidden';" -->
                	</a>
                </div>
           </div>  
        </div>
