						...
						<div class="container" >
							<div class="row up_yl_container1" style="padding-top:6%">
                                <div class="col-xs-6 up_yl_border">
                                    ...
                                    <div id="filePicker1" class="filePicker bg1"><img class="up_sfzzm" src="<%=request.getContextPath()%>/Manage/picView?imgPath=${amountUpEntity.pic1 }" alt="" class="preview" /><img class="preview" ></span></div>
                                ...
                                <div class="col-xs-6 up_yl_border">
                                	<div class="up_yl_border1"  style="border-bottom:dashed 1px #e3e3e3;">
                                        ...
                                        <div id="filePicker2" class="filePicker bg2"><img class="up_sfzzm" src="<%=request.getContextPath()%>/Manage/picView?imgPath=${amountUpEntity.pic2 }" alt="" /><img class="preview" /></div>
							...
							<div class="row up_yl_container1" style="padding-top:2%">
                                ...
                                <div class="col-xs-6 up_yl_border">
                                	<div class="up_yl_border1"  style="border-bottom:dashed 1px #e3e3e3;"> 
                                        ...
                                        <div id="filePicker4" class="filePicker bg4"><img class="up_sfzzm" src="<%=request.getContextPath()%>/Manage/picView?imgPath=${amountUpEntity.pic4 }" alt="" /><img class="preview" /></span></div>
							...
							<div class="row up_yl_container1" style="padding-top:2%">
                                ...
                                <div class="col-xs-6 up_yl_border">
                                	<div class="up_yl_border1">
                                        ...
                                        <div id="filePicker6" class="filePicker bg6"><img class="up_sfzzm" src="<%=request.getContextPath()%>/Manage/picView?imgPath=${amountUpEntity.pic6 }" alt="" /><img class="preview" /></span></div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="container_modal">
                    <ul class="ctgl_container">
                        <li class="top_bottom">
                            <div class=" row"  style="padding-left:10px; padding-right:10px;">
                                <div class="col-xs-12" style=" padding-bottom:10px;">
                                	<dl>
                                    	<dt>温馨提示：</dt>
                                    	<dd>体验客户（未上传照片）：单笔交易限额xxx以内;</dd>
                                        <dd>实名认证（无营业执照）：单笔交易限额xxx以内;</dd>
                                        <dd>商家经营（有营业执照）：单笔交易限额xxx以内</dd>
                                    </dl>
                                </div>
                            </div>
                        </li>
                        <li style="border-top:solid 1px #dbdbdb;">
                            <div class="jdxx_text row" style="padding-left:15px; padding-right:15px;">
                                <div class="col-xs-6" style="border-right:solid 1px #dbdbdb; padding:12px 0;">
                                	<a href="<%=request.getContextPath()%>/jsp/manage/upload.jsp"><button type="button" value="">商家经营</button></a>
                                </div>
                                <div class="col-xs-6"  style=" padding:12px 0;">
                                	<a href="<%=request.getContextPath()%>/jsp/manage/upload2.jsp"><button type="button" value="">实名认证</button></a>
                                </div>
                            </div>
                        </li>
                    </ul>
