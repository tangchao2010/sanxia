...
<div class="container-fluid  achieve_se_container" >
    <div class="achieve_container">
            <div class="row " style="padding:0; margin:0;">
                <div class="col-md-12 col-sm-12 col-xs-12 achieve_pic">
                    <img class="center-block"  width="40%" src="<%=request.getContextPath()%>/img/imgs/ewm.jpg">
                    <dl>
                        <dd class="user_name">商户</dd>
                        <dd class="user_tel">18668526988</dd>
        ...
        <div class="row" style=" margin:0; padding-top:6%;padding-bottom:8%;">
			<div class="col-xs-8 col-xs-push-2">
            	<div class="row achieve_se">
                    ...
                    <div class="col-xs-9 achieve_sex"><span><a><%--${}--%></a></span></div>
                </div>
                <div class="row achieve_se">
    ...
    <div style=" text-align:center; padding-top:5%; padding-bottom:14%" >
		<button id="subhold" type="submit"  style=" text-shadow:none; background:#073348; border:none;  width:90%" class=" btn  btn-default btn-lg"><a onclick="window.close();" style="font-weight:normal; text-decoration:none; color:#fff; font-family:'微软雅黑';  "> 获取邀请码</a></button>
	 </div>
	</form>
