...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<style>
			...
			.upload_container{ padding-right:15px; padding-left:15px; padding-top:3%; padding-bottom:6%;}
			...
			@media screen and (max-width:320px){
				.filePicker {overflow: hidden; margin: 0; max-height: 76px; max-width:252px;}
			...
			@media screen and (min-width:321px) and (max-width:374px){
				.filePicker {overflow: hidden;margin: 0; max-height: 84px; max-width:252px}
				.filePicker .webuploader-pick {
							position: relative;
							display: inline-block;
							cursor: pointer;
		...
		.input-yyzz{ margin:0 15px 20px 15px; width:100%; }
		.input-yyzz em{ font-style:normal; font-size:14px; color:#333; float:left;}
		.input-yyzz input{text-indent:1rem;border-radius:4px;border:solid 1px #e3e3e3;width:70%; line-heihgt:40px;;background:#fff; font-size:14px; color:#666;}
		</style>
        <script>
        	$(function(){
...
<body  style="background:#f5f5f5">
    ...
    <img onclick= "javascript:history.back(-1)" src="<%=request.getContextPath()%>/img/wcb/arrowb.png;" style=" float:left; height:22px; margin-top:10px; display:block; position:absolute; z-index:9999"/>
    	<h1 class="title">商家经营</h1>
    </header>
	<div class="container-fluid">
        <div class="zccg_container" style="margin-top:60px">
			<form id="defaultForm" method="post" action="#">
				...
				<div class="upload_container">
                    ...
                    <div class="input-yyzz"><em>商户信息</em>&nbsp;&nbsp;<input name="baseOrgLicence" type="text" value="" placeholder="营业执照号"\></div>
							...
							<div class="row up_yl_container1" style="padding-top:6%">
                                ...
                                <div class="col-xs-6 up_yl_border">
                                	<div class="up_yl_border1"  style="border-bottom:dashed 1px #e3e3e3;">
                                        ...
                                        <div id="filePicker2" class="filePicker bg2"><img class="preview" /></div>
				...
				<div style=" text-align:center; padding-top:1%; padding-bottom:8%;" >
                    <button  id="upload" type="submit"  style=" text-shadow:none; background:#0368b1; border:none;  width:90%" class=" btn  btn-default btn-lg">
