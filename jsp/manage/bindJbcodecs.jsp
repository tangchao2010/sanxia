...
<head>
    ...
    <style>
		.bcmm_box input{ color:#252626;}
  		.bcmm_box .numid2, .bcmm_box numid4 {
		...
		<div class="page page-current">
            ...
            <div class="content">
            	<div class="content-block codephone">
                	<span>验证码已经发送到&nbsp;<em>${phone }</em></span>
                </div>
				...
				<div>
                    ...
                    <div class="bcmm_box" style="text-align: center;">
                        <form id="password" >
                        	<input type="hidden" name="oemid" readonly value="${oemid }"><input type="hidden" readonly name="openid" value="${openid }"><input type="hidden" readonly name="orgCode" value="${orgCode }"><input type="hidden" readonly name="phone" value="${phone }"><input type="hidden" readonly name="cvvId" value="${cvvId }"><input id="numid1" name="numid1" readonly class="inputpass" type="password" maxlength="1" value=""><input id="numid2" name="numid2" readonly class="inputpass" type="password"maxlength="1"value=""><input id="numid3" name="numid3" readonly class="inputpass" type="password"maxlength="1"value=""><input id="numid4" name="numid4" readonly class="inputpass" type="password"maxlength="1"value=""><input id="numid5" name="numid5" readonly class="inputpass" type="password"maxlength="1"value=""><input id="numid6" name="numid6" readonly class="inputpass"  type="password"maxlength="1"value=""  >
                        </form>
                    </div>
	...
	<script type="text/javascript">
		...
		function myan(){
			$.post("<%=request.getContextPath()%>/kuaijie/jiebangend", {
				...
				if(json.code == 0) {
					$.alert('银行卡解绑成功', function () {
						window.location.href='<%=request.getContextPath()%>/kuaijie/cardList?orgCode=${orgCode}&openid=${openid}&oemid=${oemid}';
					});
