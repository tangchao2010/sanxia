...
<input type="hidden" id="curPage" name="curPage" value="${curPage}">
			...
			<div class="content">
				<div class="content-block ">
					<div class="wcb_container ">
                                ...
                                <div class="lie container">
                                    <div class="row">
                                        <div class="col-xs-2 data_img">
                                            <a style=" color:#262626; font-size:14px; font-family:'微软雅黑'; width:20%"><img id="dateclick"  height="32px" src="<%=request.getContextPath()%>/img/imgs/paydata.png" /></a>
                                        </div>
                                        <div class="col-xs-9" >
						...
						<div id="wrapper2" class="rechargemain" >
							<ul>
							<%-- 	<!--<li>
									<dl class="rechargetop rechargepublic">
                                    	<dd>充值</dd>
                                        <dd>2017-12-12 16:00:00</dd>
                                    </dl>
                                	<dl class="rechargemid rechargepublic  shareLoan">
                                    	<dd>30222.23</dd>
                                        <dd><em>支付宝</em><img src="<%=request.getContextPath()%>/img/wcb/zfbpay.png"></dd>
                                    </dl>
                                    <dl class="rechargetop rechargepublic rechargetbot" >
                                        <dd class="state">已完成</dd>
                                    </dl>
								</li>--> --%>
                            </ul>
						</div>
    ...
    <script>	
	$(function(){
		$("#wrapper2").find(".state").each(function() {
			var complet= $(this).html();
			if(complet == "交易成功"){
				$(this).css("color","#59cd46");	
			}else{
				$(this).css("color","#f85a59");	
			}	
    ...
    <script type="text/javascript">
            ...
            function Ycallback(seldatatime,isappend){
            	...
            	$.post("<%=request.getContextPath()%>/wode/chongzhiJson", {
				...
				//alert(document.querySelectorAll("#wrapper2 ul li").length);
					...
					$.each(data.payRecordsList, function(index, item){//遍历数组
						...
						var tmpHtml = '<li>'+
										...
										'<dl class="rechargemid rechargepublic  shareLoan">'+
											'<dd>'+item.moeny+'分</dd>'+
											'<dd>'+'<em>'+'微信'+'</em>'+'<img src="<%=request.getContextPath()%>/img/wcb/wxpay.png">'+'</dd>'+
										'</dl>'+
										'<dl class="rechargetop  rechargetbot">'+
											'<dd class="state">'+item.reserve3+'</dd>'+
										'</dl>'+
									'</li>';
