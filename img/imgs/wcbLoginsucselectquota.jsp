...
<body style="background:#f2f2f2">
    ...
    <p style=" text-align:center; font-size:.3rem; color:#999; bottom:0; position:fixed;  width:100%; height:1.2rem; ">联系电话：<a href="tel:400-114-3788"  style=" color:#ffd601; " >400-114-3788</a></p>
	<script type="text/javascript" src="<%=request.getContextPath()%>/js/jquery-1.11.3.min.js"></script>
   	<script>
    	function an(id){
			...
			window.location.href = "<%=request.getContextPath()%>/weixinpay/GZHPAY?oemid="+oemid+"&orgCode="+orgCode+"&openid="+openid+"&goodsId="+id+"&flog=2";
	}
    </script>   
</body>
</html>
